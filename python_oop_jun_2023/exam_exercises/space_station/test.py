...
# print(station.add_planet('New Planet', 'stone'))
...
# print(station.send_on_mission('New Planet'))  # should Exception("You need at least one astronaut to explore the planet!")
