...
if 10 <= degrees <= 18 and time_of_day == "Morning":
    ...
    outfit = "Shirt"
    shoes = "Moccasins"
if 18 < degrees <= 24 and time_of_day == "Morning":
    outfit = "Shirt"
    shoes = "Moccasins"
    ...
    outfit = "Shirt"
    shoes = "Moccasins"
if degrees > 24 and time_of_day == "Morning":
    outfit = "T-Shirt"
    shoes = "Sandals"
elif degrees > 24 and time_of_day == "Afternoon":
    outfit = "Swim Suit"
    shoes = "Barefoot"
elif degrees > 24 and time_of_day == "Evening":
    outfit = "Shirt"
    shoes = "Moccasins"
