# Generated by Django 4.2.4 on 2023-11-09 09:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_year', models.PositiveIntegerField(validators=[main_app.validators.video_game_release_year])),
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.video_game_rating])),
            ],
        ),
        migrations.CreateModel(
            name='Project',
